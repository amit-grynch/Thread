...
public class TerminatingThreadsSecondTechnique {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		t1.interrupt();
		System.out.println("[" + currentThreadName + "] Interrupting Status : " + t1.isInterrupted() + "....");
		
		System.out.println("[" + currentThreadName + "] Interrupting " + t2.getName() + "....");
		t2.interrupt();
		System.out.println("[" + currentThreadName + "] Interrupting Status : " + t2.isInterrupted() + "....");
		
		System.out.println("[" + currentThreadName + "] Interrupting " + t3.getName() + "....");
		t3.interrupt();
		System.out.println("[" + currentThreadName + "] Interrupting Status : " + t3.isInterrupted() + "....");
