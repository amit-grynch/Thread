...
/**
 * @author amitg Using CompletionService to render page elements as they become
 *         available
 */
public abstract class RenderImage {
	...
	void renderImage(CharSequence s) {
		...
		CompletionService<ImageData> executorCompletionService = new ExecutorCompletionService<ImageData>(
				executorService);
